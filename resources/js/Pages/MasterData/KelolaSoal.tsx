...
interface KelolaSoalProps {
    // Nanti tim backend akan menambahkan definisi data di sini
    judul?: string; 
}

export default function KelolaSoal({ judul = "KelolaSoal" }: KelolaSoalProps) {
    return (
        <div className="min-h-screen bg-gray-50 p-8">
            <Head title="KelolaSoal" />
            ...
            <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="p-4 border border-dashed border-gray-300 rounded text-center text-gray-400">
                    Area konten KelolaSoal akan diletakkan di sini
                </div>
            </div>
        </div>
    );
